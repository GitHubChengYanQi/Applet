<template>
<uni-shadow-root class="cascader-index"><view v-if="showHeader" class="van-cascader__header">
...
global['__wxRoute'] = 'cascader/index'
...
export default global['__wxComponents']['cascader/index']
</script>
