<template>
<uni-shadow-root class="calendar-calendar"><view class="van-calendar">
...
global['__wxRoute'] = 'calendar/calendar'

Component({})

export default global['__wxComponents']['calendar/calendar']
</script>
