<template>
<uni-shadow-root class="van-stepper-index"><view :class="(utils.bem('stepper', [theme]))+' custom-class'">
...
global['__wxRoute'] = 'van-stepper/index'
...
export default global['__wxComponents']['van-stepper/index']
</script>
